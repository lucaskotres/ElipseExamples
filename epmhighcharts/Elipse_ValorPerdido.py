...
data_pie =[ {'name':'Total Faturado','y': 87.48},
            {'name':'Total Perdido','y':12.51,'sliced':True }

          ]



chart = Highchart(height=700,width=1635)
...
chart.save_file('Elipse_ValorPerdido')
