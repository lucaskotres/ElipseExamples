...
parser.add_argument('-f',
                    help='(Optional) if using json configfile - format:{"server":"servername","user":"username",'
                         '"bvname":"bvname","csvfile":"csvfilepath","value":"valuecolumnname","timestamp":"timestampcolumnname"}')
...
try:
    ...
    #TODO: Conseguir capturar essa excecao, esta passando direto.
except Exception:
...
#TODO: Verificacao de inconsistencias - comparacao entre o datatemp e uma consulta raw do mesmo periodo.
